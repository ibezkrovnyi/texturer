...
// image quantizer
RgbQuant.prototype.getReduced32 = function reduce(
  palette,
  img,
  width,
  dithKern,
...
RgbQuant.prototype.getReduced8 = function reduce(
  palette,
  img,
  width,
  dithKern,
...
var rd = 255,
  ...
  ad = 255,
  maxDist = Math.sqrt(
    Pr * rd * rd + Pg * gd * gd + Pb * bd * bd + Pa * ad * ad,
  );
...
RgbQuant.prototype.colorDist = function(rgba0, rgba1) {
  ...
  return (
    Math.sqrt(Pr * rd * rd + Pg * gd * gd + Pb * bd * bd + Pa * ad * ad) /
    maxDist
  );
};
