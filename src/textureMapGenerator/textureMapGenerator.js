...
/**
 * @param {{id : string, width : number, height : number}} files
 * @param {TextureMapConfig} textureMapConfig
 * @param {function(textureMapDictionary: Dictionary)} callback
 * @param {number} thisArg
 */
TextureMapGenerator.prototype = {
	generateTextureMap : function (files, textureMapConfig, callback, thisArg) {
		try {
	...
	_onPlaceFilesFinished : function (error, bestTextureMapDictionary) {
	...
	_placeFiles : function (textureMapConfig, files) {
	...
	_getShuffledArray : function (arr) {
...
module.exports = TextureMapGenerator;
